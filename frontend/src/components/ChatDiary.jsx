...
const AREAS = [
  // 마스코트는 result.js MASCOTS 의 역할 분담을 따른다 — 노바(기회·변화) · 코스모(데이터·선택 분석) ·
  // 루미(기록을 돌봄)는 설정의 '내 생활 관리 친구'(PetMascot)·diarySignals.js 의 GUIDE_DOMAIN 과
  // 같은 배정이다. '오늘 돌아보기'는 노바, 몸·마음 체크는 루미다.
