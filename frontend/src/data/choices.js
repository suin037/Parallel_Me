...
const RELATED_ALTERNATIVES = {
  ...
  education: ["현업을 유지하며 공부를 병행하기", "진학을 미루고 단기 과정부터 들어보기", "현업을 유지하며 실무 경험과 자격을 쌓기", "지금 일을 그대로 하며 수업 하나로 먼저 시험해보기"],
  ...
  housing: ["지금 집에 그대로 머물며 불편한 조건을 개선하기", "바로 이사하지 않고 단기로 살아보기", "이사 시점을 뒤로 미루고 자금을 먼저 모으기", "지금 생활권에 남아 다른 조건을 찾아보기"],
