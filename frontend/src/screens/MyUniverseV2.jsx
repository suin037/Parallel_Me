...
function PlanetModal({ planet, state, profile, onClose, onSimulate, onPickOpportunity }) {
  ...
  return <aside data-tour="planet-panel" className={`absolute inset-y-2 right-2 z-40 ${PANEL_W} overflow-y-auto rounded-[26px] border border-white/10 bg-[#070E1B]/95 shadow-[0_30px_100px_rgba(0,0,0,.72)] backdrop-blur-2xl lg:inset-y-4 lg:right-4`}>
